...
public class Fenetre extends JFrame
{
     ...
     * Permet de changer le JLabel contenant le pseudo
     *
     * @return     Le contenu du JLabel
     */
    public String getPseudo()
    {
        return l_pseudo.getText();
    }
    ...
    {
        gestionnaire.modifierAlbum(colonne, newValeur , titre, auteur,l_pseudo.getText());
    }
    ...
    { 
        if (gestionnaire.verifAuteurTitre(titre,auteur,l_pseudo.getText()))
        {
            JOptionPane.showMessageDialog(this,"L'album " + titre + " de " + auteur + " existe déjà dans la base de données !","Erreur",JOptionPane.ERROR_MESSAGE);
        }
        else
        { 
            gestionnaire.ajouterAlbum(genre, titre, auteur,date,l_pseudo.getText(),lien,lien_image);
    ...
    {
        if (gestionnaire.nbLigneAlbum(l_pseudo.getText()) == 0)
        {
        ...
        else
        {
            ...
            for (int i=0; i < gestionnaire.nbLigneAlbum(l_pseudo.getText()); i++)
            {
    ...
    {
        if (gestionnaire.nbLigneAlbumFiltre(l_pseudo.getText(),colonne,filtre) == 0)
        {
            JOptionPane.showMessageDialog(this,"La recherche n'a pas aboutie");
        ...
        else
        {
            tabalbums.clear();
            panel_tableau.removeAll();
            for (int i=0; i < gestionnaire.nbLigneAlbumFiltre(l_pseudo.getText(),colonne,filtre); i++)
            {
                tabalbums.addElement(new LigneAlbum(this));
                panel_tableau.add(tabalbums.lastElement());
            }
    ...
    {
        if (gestionnaire.nbLigneAlbumFiltreDate(l_pseudo.getText(),filtre,symbole) == 0)
        {
            JOptionPane.showMessageDialog(this,"La recherche n'a pas aboutie");
            b_reinitialiser.setEnabled(false);
        }
        else
        {
            tabalbums.clear();
            panel_tableau.removeAll();
            for (int i=0; i < gestionnaire.nbLigneAlbumFiltreDate(l_pseudo.getText(),filtre,symbole); i++)
            {
                tabalbums.addElement(new LigneAlbum(this));
                panel_tableau.add(tabalbums.lastElement());
            }
    ...
    {
        rempliralbum();
        gestionnaire.selectAlbum(l_pseudo.getText(),tabalbums);
    ...
    {
        gestionnaire.supprimerunalbum(album.getDonnees().getTitre(), album.getDonnees().getAuteur(),l_pseudo.getText());
    ...
    public void rechercher(String recherche)
    {
        if (b_filtre.getSelectedItem().toString().equals("Date"))
        {
            ...
            gestionnaire.rechercherAlbumDate(tabalbums,l_pseudo.getText(),recherche,b_filtre_date.getSelectedItem().toString());
        }
        else
        {
            if ((b_filtre.getSelectedItem().toString().equals("Titre")))
            {
                rempliralbumfiltre("titre",recherche);
                gestionnaire.rechercherAlbum(tabalbums,l_pseudo.getText(),"titre",recherche);
            }
            else if ((b_filtre.getSelectedItem().toString().equals("Auteur")))
            {
                rempliralbumfiltre("auteur",recherche);
                gestionnaire.rechercherAlbum(tabalbums,l_pseudo.getText(),"auteur",recherche);
            }
            else if ((b_filtre.getSelectedItem().toString().equals("Genre")))
            {
                rempliralbumfiltre("genre",recherche);
                gestionnaire.rechercherAlbum(tabalbums,l_pseudo.getText(),"genre",recherche);
            }
        }
        if (!tabalbums.isEmpty())
    ...
    private void l_supprimerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_l_supprimerMouseClicked
        if (!tabalbums.isEmpty())
        {
            ...
            {
                vider();
                gestionnaire.supprimertoutalbum(l_pseudo.getText());
            }
        }
        else
